...
- "fornitore_servizio": Il fornitore del servizio telematico/satellitare, scegliendo rigorosamente tra: GEOTAB, SAMSARA, W.A.Y., WEBFLEET, FLOTTAWEB, GOLIA, MULTIPROTEXION, ALTRO. Deducibile dai dispositivi fotografati. Regole aggiuntive: 1) se rilevi un seriale dispositivo che inizia con "WP24" (es. WP24070392S00098), si tratta di un'installazione SIDEWAY e il fornitore DEVE ESSERE "W.A.Y.". 2) se sul seriale vedi in mezzo "22Q1 -xxxx" (o formati simili con Q) è "W.A.Y."; 3) se compare la scritta "raliacom", "Geotab" o "VISIRUN", usa "GEOTAB"; 4) se vedi la scritta o il logo "SAMSARA" sulle etichette dei dispositivi, usa "SAMSARA". Se non visibile, usa null.
- "lavorazione_eseguita": tipo di intervento in buon italiano tecnico. REGOLA AGGIUNTIVA: se hai rilevato un seriale che inizia con "WP24", la lavorazione DEVE ESSERE ESATTAMENTE "installazione dispositivo angolo cieco SIDEWAY".
