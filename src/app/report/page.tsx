                                    ...
                                    <div style={{ padding: '12px 0' }}>
                                        {cluster.records.map((rec, rIdx) => (
                                            <div key={rIdx} style={{
                                                ...
                                                <div style={{ width: '56px', height: '56px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#2a2a2a', borderRadius: '12px', padding: '6px' }}>
